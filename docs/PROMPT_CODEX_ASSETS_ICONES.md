# PROMPT CODEX — 1re CAMPAGNE (lots 1-7) — ARCHIVE : TOUT LIVRÉ ET INTÉGRÉ

⚠ Ce document est l'ARCHIVE de la première campagne (livrée 2026-08-19,
intégrée commits 86a7813 → 7d3dbe6). Pour la campagne EN COURS, voir
docs/PROMPT_CODEX_ASSETS_LOTS_8-13.md.
