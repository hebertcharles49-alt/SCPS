...
static const EventDef EVENTS[EVID_COUNT] = {
    [EVID_QUAKE] = { EVID_QUAKE, EV_PROVINCE, "La terre tremble", trig_quake, 8000.f, NULL,
        {{ "Subir le séisme", "Le sol se déchire : édifices effondrés, vies fauchées, ordre ébranlé.",
    ...
    [EVID_FLOOD] = { EVID_FLOOD, EV_PROVINCE, "Les eaux débordent", trig_flood, 5000.f, NULL,
        {{ "Subir la crue", "La crue emporte des récoltes, mais le limon laisse une terre plus grasse.",
    ...
    [EVID_DROUGHT] = { EVID_DROUGHT, EV_PROVINCE, "La sécheresse s'installe", trig_drought, 6000.f, NULL,
        {{ "Subir la sécheresse", "La pluie se refuse ; les greniers se vident et la colère monte.",
    ...
    [EVID_FIRE] = { EVID_FIRE, EV_PROVINCE, "Le feu court sur la forêt", trig_fire, 7000.f, NULL,
        {{ "Subir l'incendie", "Les flammes ravagent les bois et ouvrent, de force, des terres à la charrue.",
    ...
    [EVID_PLAGUE] = { EVID_PLAGUE, EV_PROVINCE, "La peste remonte les routes", NULL, 12000.f, NULL,
        {{ "Subir l'épidémie", "Le mal voyage avec les marchands : il frappe d'autant plus fort les grands carrefours ouverts.",
    ...
    [EVID_PARENTE_LOINTAINE] = { EVID_PARENTE_LOINTAINE, EV_COUNTRY, "Un peuple d'outre-monde, jamais rencontré mais du même sang culturel, tend la main",
        trig_parente_lointaine, 1825.f, NULL, {
        { "Renouer",
          "On reçoit leur ambassade et on ouvre un canal d'influence, contre un peu d'or.",
          { .d_L=0.2f, .d_influence=2.f, .d_treasury_mois=-0.3f, .unlock_branch=-1 },
          0.5f, { .faction=-1, .faction_strength=0.f, .scar_kind=SCAR_NONE, .cooldown_days=1825 },
          "Les cousins renouent une amitié lointaine, mais bien réelle." },
        { "Rester distant",
          "Le sang culturel ne fait pas une alliance : on garde ses distances, sans y perdre.",
          { .unlock_branch=-1 },
          0.4f, { .faction=-1, .faction_strength=0.f, .scar_kind=SCAR_NONE, .cooldown_days=1825 },
          "La distance se maintient, ni chaude, ni froide, simplement lointaine." },
        { "Exploiter la parenté",
          "On monnaie la parenté : un peu d'or contre du crédit auprès des cousins.",
