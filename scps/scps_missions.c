...
/* ── LE PRIX DU PIVOT — branché sur l'INFLUENCE POLITIQUE (merge 2026-09-02).
 * Le pointeur est lié par scps_sim.c à l'init (dessein_pivot_bind) ; NULL
 * (bancs missions_demo, chronique sans influence) = pivot gratuit — le banc
 * teste la MACHINE de scellage, l'économie du prix vit dans influence_demo. */
