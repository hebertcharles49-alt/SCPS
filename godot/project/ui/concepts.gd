...
const DEFS := {
	...
	"Développement": {"d": "L'assise administrative d'une province (0-100) : elle porte la stabilité, la capacité des services et le respect de l'impôt.", "i": "capital_tower"},
