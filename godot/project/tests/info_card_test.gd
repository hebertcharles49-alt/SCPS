...
func _initialize() -> void:
	...
	_check(bb.contains("•") and bb.contains("url=close"), "présentation en liste ou fermeture absente")
	_check(not bb.contains("url=pin"), "un hover ne doit plus rester épinglé hors de sa hitbox")
	server.free()
